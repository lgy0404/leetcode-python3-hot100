...
我的程序（使用哈希表存储左右括号的关系），参考[20. 有效的括号 - 力扣（LeetCode）](https://leetcode.cn/problems/valid-parentheses/solutions/9185/valid-parentheses-fu-zhu-zhan-fa-by-jin407891080/)****
